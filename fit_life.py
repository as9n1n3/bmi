print("Привет! Я бот-помощник для расчёта норм воды и калорий.")
...
print(
    f"\n{user_name}, теперь мне нужно узнать "
    "твои параметры."
)

user_weight = float(
    input("Введи вес (кг, например 75.5): ")
)
...
print("Результаты расчётов для", user_name, "(возраст:", user_age, "лет):")
